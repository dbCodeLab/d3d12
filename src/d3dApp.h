...
class D3DApp
{
	...
	static const float MOUSE_FILTER_WEIGHT;
...
protected:
	...
	DirectX::XMFLOAT2 mouseHistory[MOUSE_HISTORY_BUFFER_SIZE];
	
	ULONG mAppCounter = 1; // Simple Application counter
	ULONG                GetAppCounter() const { return mAppCounter; }
	void                 IncrementAppCounter() { mAppCounter++; }
};
